...
function createDayTable(homePage,inDate){
    ...
    if(globalDaysManager.getDayByDate(dayDate).restriction==null){
        notification.innerHTML="Выберите день.";
        notification.style.color = "red";
    }else{
        notification.innerHTML="Ограничения";
    ...
    node.appendChild(document.createTextNode("Всего калорий за день"));
    tr.appendChild(node);
    ...
    deleteB.appendChild(document.createTextNode("Удалить день"));
...
function createDayMealsTable(homePage,day){
    ...
    if(day){
        ...
        console.error("Дата должна быть выбрана");
        throw "Недопустимо";
    }
    ...
    caption.appendChild(document.createTextNode("Продукты"));
    ...
    node.appendChild(document.createTextNode("Наименование"));
    tr.appendChild(node);
    node = document.createElement("th");
    node.appendChild(document.createTextNode("Белки"));
    tr.appendChild(node);
    node = document.createElement("th");
    node.appendChild(document.createTextNode("Углеводы"));
    tr.appendChild(node);
    node = document.createElement("th");
    node.appendChild(document.createTextNode("Жиры"));
    tr.appendChild(node);
    node = document.createElement("th");
    node.appendChild(document.createTextNode("Калорий"));
    tr.appendChild(node);
    ...
    node = document.createElement("td");
    node.appendChild(document.createTextNode("Завтрак"));
    ...
    tr = document.createElement("tr");
    node = document.createElement("td");
    node.appendChild(document.createTextNode("Обед"));
    node.setAttribute("colspan","5");
    node.style.textAlign = "center";
    node.style.backgroundColor = "gainsboro";
    tr.appendChild(node);
    ...
    tr = document.createElement("tr");
    node = document.createElement("td");
    node.appendChild(document.createTextNode("Ужин"));
    node.setAttribute("colspan","5");
    node.style.textAlign = "center";
    node.style.backgroundColor = "gainsboro";
    tr.appendChild(node);
    ...
    tr = document.createElement("tr");
    node = document.createElement("td");
    node.appendChild(document.createTextNode("Легкий перекус"));
    node.setAttribute("colspan","5");
    node.style.textAlign = "center";
    node.style.backgroundColor = "gainsboro";
    tr.appendChild(node);
...
function createDayExerciseTable(homePage,day){
    ...
    if(day){
        ...
        console.error("Дата должна быть");
        throw "Недопустимо";
    }
    ...
    var caption = document.createElement("caption");
    caption.appendChild(document.createTextNode("Упражнения"));
    caption.style.textAlign = "center";
    ...
    tr = document.createElement("tr");
    node = document.createElement("td");
    node.appendChild(document.createTextNode('Итого'));
    tr.appendChild(node);
    node = document.createElement("td");
...
function createGlobalExercisesTable(homePage,date){
    ...
    tabExercises.className = "dayTable" ;
    var caption = document.createElement("caption");
    caption.appendChild(document.createTextNode("Упражения"));
    caption.style.textAlign = "center";
    tabExercises.appendChild(caption);
    //create head table
    var thead = document.createElement("thead");
    ...
    tr.appendChild(node);
    node = document.createElement("th");
    node.appendChild(document.createTextNode("Расход калорий"));
    node.onclick = function(){
        if(commonSort=="asc"){
...
function createFootWithRestriction(homePage,day,manager){
    ...
    if(restriction.protein==null||restriction.protein==""){
        ...
        if(manager.sumProtein()>Number(restriction.protein)){
            ...
            notification.innerHTML="Белок за этот день был превышен!";
            notification.style.color="red";
        }
    }
    tr.appendChild(node);
    ...
    if(restriction.carbohydrate==null||restriction.carbohydrate==""){
        ...
        if(manager.sumCarbohydrate()>Number(restriction.carbohydrate)){
            node.style.color="red";
            notification.innerHTML="Углеводы за этот день были превышены!";
            notification.style.color="red";
        }
    }
    tr.appendChild(node);
    ...
    if(restriction.fat==null||restriction.fat==""){
        ...
        if(manager.sumFat()>Number(restriction.fat)){
            node.style.color="red";
            notification.innerHTML="Жиры за этот день были превышены!";
            notification.style.color="red";
        }
    }
    tr.appendChild(node);
    ...
    if(restriction.kcal==null||restriction.kcal==""){
        ...
        if(manager.sumKcal()>Number(restriction.kcal)){
            node.style.color="red";
            notification.innerHTML="Употребление калорий за этот день превышено";
            notification.style.color="red";
        }
    }
    tr.appendChild(node);
